...
//    private null trainCo;

//    private null beginRow;
...
//    private null pageRow;

    private String statnId;

//    private null subwayNm;
...
//    public null getCurPage ()
//    {
//        return curPage;
//    }
//
//    public void setCurPage (null curPage)
//    {
...
//    public null getTrainCo ()
//    {
//        return trainCo;
//    }
//
//    public void setTrainCo (null trainCo)
//    {
//        this.trainCo = trainCo;
//    }
//
//    public null getBeginRow ()
//    {
//        return beginRow;
//    }
//
//    public void setBeginRow (null beginRow)
//    {
...
//    public null getEndRow ()
//    {
//        return endRow;
//    }
//
//    public void setEndRow (null endRow)
//    {
//        this.endRow = endRow;
//    }
...
//    public null getBtrainSttus ()
//    {
//        return btrainSttus;
//    }
//
//    public void setBtrainSttus (null btrainSttus)
//    {
...
//    public null getPageRow ()
//    {
//        return pageRow;
//    }
//
//    public void setPageRow (null pageRow)
//    {
...
//    public null getSubwayNm ()
//    {
//        return subwayNm;
//    }
//
//    public void setSubwayNm (null subwayNm)
//    {
...
//    }
    ...
    public String toString()
    {
        ...
        return "ClassPojo [statnList = "+statnList+", statnFid = "+statnFid+", selectedCount = "+selectedCount+", btrainNo = "+btrainNo+", subwayList = "+subwayList+", statnTid = "+statnTid+", subwayId = "+subwayId+", totalCount = "+totalCount+", statnNm = "+statnNm+", bstatnNm = "+bstatnNm+", recptnDt = "+recptnDt+", arvlCd = "+arvlCd+", bstatnId = "+bstatnId+", barvlDt = "+barvlDt+", subwayHeading = "+subwayHeading+", arvlMsg3 = "+arvlMsg3+", arvlMsg2 = "+arvlMsg2+", updnLine = "+updnLine+", trainLineNm = "+trainLineNm+", ordkey = "+ordkey+", rowNum = "+rowNum+", statnId = "+statnId+"]";
    }
}
