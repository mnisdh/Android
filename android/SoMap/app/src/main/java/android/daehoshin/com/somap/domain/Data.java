...
public class Data {
    ...
    {
        return "ClassPojo [zone_id = "+zone_id+", visit_link = "+visit_link+", link = "+link+", zone_attr = "+zone_attr+", state = "+state+", albe_num = "+albe_num+", visit = "+visit+", notice_oneway = "+notice_oneway+", lng = "+lng+", zone_addr = "+zone_addr+", id = "+id+", zone_alias = "+zone_alias+", total_num = "+total_num+", zone_name = "+zone_name+", zone_props = "+zone_props+", oper_time = "+oper_time+", notice = "+notice+", lat = "+lat+", oper_way = "+oper_way+"]";
    }
}
